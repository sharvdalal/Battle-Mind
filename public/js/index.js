...
async function lastStage() {
  ...
  if (lowUserAns.trim() == answer) {
    ...
    $("#" + removeCurrImg).html("");
    $("#" + logicArray[myCurrentPosition[0]][myCurrentPosition[1]]).addClass("correctPath");
    $("#" + logicArray[logicArray.length - 1][logicArray[0].length - 1]).addClass("correctPath");
...
atLastStage = false;
  ...
  $(".muteUnmute").attr("src", "public/images/volume-unmute.png");
...
const questions = {                 // 30 ques
  ques: [
    ...
    { ques1: " Ctrl, Shift and Alt are called .......... keys.",
    corr_ans: "modifier",
    wrong_ans: "function",
    },
